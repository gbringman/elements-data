...
Reducer<IntWritable, MapWritable, Text, Text> {
    ...
    public static final String pageBreakTag = "<pb n=\"\\d*\"\\s*/>";
    public static final String pageBreakTagWithPage = "<pb n=\"%d\"\\s*/>";
    
    /**
     * Retrieve the text of page from a version of the <em>Éléments de Physiologie</em> 
     * corpus.
     * 
     * @param pageNo
     *      The page number to retrieve from {@code version}.
     * @param version
     *      The version with an identifying key [DPV|V|L], with corpus as value.
     * @param context
     ...
     *      If either key or value cannot be added to the context.
     */
    public void reduce(IntWritable pageNo, ElementsMapWritable version, Context context)
