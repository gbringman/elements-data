...
/**
 * Fetch a page from a document source exposed to the service implementation and 
 * apply a page model. Search source can be a partitioned document or corpus on 
 * HDFS or not.
 * 
 ...
 * @return
 *      A collection different retrieved texts with marked line ranges.
 */
